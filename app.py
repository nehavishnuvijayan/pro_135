...
def save():
    ...
    day_entry_list = pd.read_csv("C:\Users\User\OneDrive\Documents\python folder\PRO135_Project_Template-main\static\assets\datafiles\updated_product_dataset.csv")

    # Log the data in the file
    day_entry_list.append(data_entry)
